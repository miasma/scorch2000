...
public class ShopWindow extends sWindow implements ActionListener,
        KeyListener {
    private final Button finish = new Button("Confirm order");
    private final Button cancel = new Button("Cancel order");
    private final Button leave = new Button("Leave the game");
    ...
    public ShopWindow(int w, int h, ScorchApplet owner) {
        ...
        Panel mainPanel = new Panel(new BorderLayout(0, 0));
